...
[*LateX_Basic_Codes.tex*](https://github.com/rlBessa/LateX/blob/main/LateX_Basic_Codes.pdf) presents usefull codes used in the construction of this document. You can use it as a template for the starting point. 
