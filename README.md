...
[*LateX_Basic_Codes.tex*](repo/blob/master/other_file.md) presents usefull codes used in the construction of this document. You can use it as a template for the starting point. 
